	...
	$(".apply").on("click", function() {
		if (flag) {
			...
			if (tools.isPhoneNo(val)) {
				if (liboolean) {
					var json = '{"mobile":"' + val +
						'","product_type":"fyph","device_id":"201901152257010339f4291d83b95897ec1738c174a81501072d3cac11bfaa","form_token":"265675A8775FC0F2E819526BAA5B096D","platform":"5","flag":"MSG_REG_AND_LOGIN_","version":"1.0","juid":"3c5c6ffe31564f84b1a47e24f5c6f187","login_token":"310007d6f4854848a3f75b2a98814e34","product_type":"' +
						product_name + '"}';
					$.ajax({
						type: "post",
